...
3. Confirm you have read it before the first reply

**At the end of the session:**
1. Re-read that module's `insights.md`
2. If something substantive appeared that is not there yet — invoke the `/engineering-insights` skill to append it
