...
**На початку кожної сесії — до першої відповіді:**
1. Знайди docs або слайд, що стосується поточної теми, і прочитай його
2. Прочитай `insights.md` модуля, де буде вестися робота

**Наприкінці сесії:**
1. Перечитай `insights.md` цього модуля
2. Якщо з'явилося щось суттєве, чого там ще немає — допиши
3. Якщо нічого нового і суттєвого — не пиши нічого

> Суттєве = те, що не виводиться з коду; дивна поведінка, неочевидне рішення,
> знайдений підводний камінь. Не дублюй те, що вже є в README або gotchas.
