...
export const s = {
  ...
  nameCol: { display: "flex", flexDirection: "column", gap: 2, flex: 1, minWidth: 0 } satisfies CSSProperties,
  nameLine: { fontSize: 13, fontWeight: 600, color: "var(--text-primary)" } satisfies CSSProperties,
  agentNameBtn: (clickable: boolean): CSSProperties => ({
    background: "none",
    border: "none",
    padding: 0,
    font: "inherit",
  ...
  agentMeta: { fontSize: 12, fontWeight: 400, color: "var(--text-muted)" } satisfies CSSProperties,
  errorText: {
    fontSize: 12,
    color: "var(--crit)",
    overflow: "hidden",
  ...
  findingsRow: { display: "flex", alignItems: "center", gap: 4, fontSize: 12, color: "var(--text-muted)" } satisfies CSSProperties,
  rightCol: {
    display: "flex",
