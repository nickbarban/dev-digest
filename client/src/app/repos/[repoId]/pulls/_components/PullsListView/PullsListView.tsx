/* PR list — /repos/:repoId/pulls. Ported from screen_dashboard.jsx; fetches
   GET /repos/:id/pulls (F1). Filters/sort live in query (?status&sort&q). */
"use client";
...
export function PullsListView() {
  ...
  // Search text and sort live in the URL alongside status — same rationale:
  // filters should survive a reload/share, not just live in component state.
